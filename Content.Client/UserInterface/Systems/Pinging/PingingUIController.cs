...
[UsedImplicitly]
public sealed class PingingUiController : UIController, IOnStateChanged<GameplayState>
{
    ...
    public void OnStateEntered(GameplayState state)
    {
        CommandBinds.Builder
            .Bind(CMKeyFunctions.RMCXenoPing, InputCmdHandler.FromDelegate(_ => TogglePingingMenu(false)))
            .Register<PingingUiController>();
    }

    public void OnStateExited(GameplayState state)
    {
        CommandBinds.Unregister<PingingUiController>();
    }

    private void TogglePingingMenu(bool centered)
    {
        Logger.Debug("TogglePingingMenu");
        if (_menu == null)
        {
            // setup window
